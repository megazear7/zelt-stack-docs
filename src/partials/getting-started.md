...
The Zelt Stack is
<strong class="underline">Z</strong>od for type definitions and rune time validation,
<strong class="underline">E</strong>xpress for an api backend,
<strong class="underline">L</strong>it for user interface that is lightweight and close to the bare metal of the browser,
